    ...
    if (!selectedProject) {
        return (
            <Card
                elevation={0}
                sx={{ border: 1, borderColor: "grey.300", ml: 1, mr: 1 }}
                data-testid="InputCard--Notice--Select-Project"
            >
                <CardContent>
                    <Alert severity="info" sx={{ textAlign: "center" }}>
                        {t("select_a_project")}
                ...
                <CardContent>
                    <Grid container spacing={3}>
                        ...
                        <Grid item xs={12} sm={7} md={6} lg={4}>
                            <FormControl fullWidth>
                                <InputLabel id="select-label-typeState">
                                    {t("type")}
                                </InputLabel>
                                <Select
                                    labelId="select-label-type"
                                    id="demo-simple-select-type"
                                    data-testid="InputCard--Worktype--Select"
                                    value={selectedWorktype}
                                    required={true}
                                    label={t("type")}
                                    disabled={
                                        !!projectWorktypes && !projectWorktypes.length
                                    }
                                    onChange={(e) =>
